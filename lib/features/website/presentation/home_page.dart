    ...
    final plans = [
      (
        ...
        [
          ...
          l10n.t('pub_home_plan_ess_f4'),
          l10n.t('pub_home_plan_ess_f5'),
          l10n.t('pub_home_plan_ess_f6'),
          l10n.t('pub_home_plan_ess_f7'),
          l10n.t('pub_home_plan_ess_f8'),
        ],
        false,
        'essenziale',
      ),
      (
        ...
        [
          ...
          l10n.t('pub_home_plan_pro_f4'),
          l10n.t('pub_home_plan_pro_f5'),
          l10n.t('pub_home_plan_pro_f6'),
          l10n.t('pub_home_plan_pro_f7'),
          l10n.t('pub_home_plan_pro_f8'),
        ],
        true,
        'professionale',
      ),
      (
        ...
        [
          ...
          l10n.t('pub_home_plan_ind_f4'),
          l10n.t('pub_home_plan_ind_f5'),
          l10n.t('pub_home_plan_ind_f6'),
          l10n.t('pub_home_plan_ind_f7'),
          l10n.t('pub_home_plan_ind_f8'),
        ],
        false,
        'industriale',
      ),
            ...
            LayoutBuilder(
              builder: (context, c) {
                ...
                return GridView.count(
                  ...
                  physics: const NeverScrollableScrollPhysics(),
                  crossAxisCount: cols,
                  childAspectRatio: cols == 1 ? 0.92 : 0.48,
                  crossAxisSpacing: 16,
                  mainAxisSpacing: 16,
