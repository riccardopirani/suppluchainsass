    ...
    return [
      card(
        ...
        featureKeys: const [
          ...
          'pub_price_essenziale_f5',
          'pub_price_essenziale_f6',
          'pub_price_essenziale_f7',
          'pub_price_essenziale_f8',
          'pub_price_essenziale_f9',
          'pub_price_essenziale_f10',
          'pub_price_essenziale_f11',
          'pub_price_essenziale_f12',
        ],
        highlight: false,
      ),
      card(
        ...
        featureKeys: const [
          ...
          'pub_price_professionale_f5',
          'pub_price_professionale_f6',
          'pub_price_professionale_f7',
          'pub_price_professionale_f8',
          'pub_price_professionale_f9',
          'pub_price_professionale_f10',
          'pub_price_professionale_f11',
          'pub_price_professionale_f12',
        ],
        highlight: true,
      ),
      card(
        ...
        featureKeys: const [
          ...
          'pub_price_industriale_f5',
          'pub_price_industriale_f6',
          'pub_price_industriale_f7',
          'pub_price_industriale_f8',
          'pub_price_industriale_f9',
          'pub_price_industriale_f10',
          'pub_price_industriale_f11',
          'pub_price_industriale_f12',
        ],
        highlight: false,
      ),
    ];
