              ...
              builder: (context, c) {
                ...
                final cards = [
                  _PlanCard(
                    ...
                    features: [
                      l10n.t('pricing_starter_f1'),
                      l10n.t('pricing_starter_f2'),
                      l10n.t('pricing_starter_f3'),
                      l10n.t('pricing_starter_f4'),
                    ],
                  ...
                  _PlanCard(
                    ...
                    period: l10n.t('pub_price_period'),
                    features: [
                      l10n.t('pricing_pro_f1'),
                      l10n.t('pricing_pro_f2'),
                      l10n.t('pricing_pro_f3'),
                      l10n.t('pricing_pro_f4'),
                    ],
                    cta: l10n.t('cta_start_trial'),
                    onTap: () => context.go('/register'),
                    highlighted: true,
                  ...
                  _PlanCard(
                    ...
                    period: l10n.t('pub_price_period'),
                    features: [
                      l10n.t('pricing_business_f1'),
                      l10n.t('pricing_business_f2'),
                      l10n.t('pricing_business_f3'),
                      l10n.t('pricing_business_f4'),
                    ],
                    cta: l10n.t('cta_start_trial'),
                    onTap: () => context.go('/register'),
                    highlighted: false,
                  ...
                  _PlanCard(
                    ...
                    period: l10n.t('pub_price_period'),
                    features: [
                      l10n.t('pricing_ent_f1'),
                      l10n.t('pricing_ent_f2'),
                      l10n.t('pricing_ent_f3'),
                      l10n.t('pricing_ent_f4'),
                    ],
