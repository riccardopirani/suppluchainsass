const Map<String, String> appLocalizationsEn = {
  ...
  'billing_choose_plan': 'Choose plan',
  ...
  'billing_starter_f1': '1 company · 5-10 users',
  'billing_starter_f2': 'Base dashboard · machines + orders',
  'billing_pro_f1': '10-30 users · AI risk and inventory',
  'billing_pro_f2': 'Supplier monitoring + supply chain risk',
  'billing_business_f1': 'Unlimited/50+ users · full AI automation',
  'billing_business_f2': 'Demand forecasting · auto-replenishment · multi-warehouse',
  'billing_enterprise_f1': 'Custom SLA · ERP integrations · dedicated support',
  'onboarding_company_setup_subtitle':
      'Create your company workspace and continue with your selected billing plan.',
  'pricing_starter_f1': '1 company · 5-10 users',
  'pricing_starter_f2': 'Base dashboard',
  'pricing_starter_f3': 'Machine management',
  'pricing_starter_f4': 'Order management',
  'pricing_pro_f1': '10-30 users',
  'pricing_pro_f2': 'AI failure risk',
  'pricing_pro_f3': 'AI supply chain risk',
  'pricing_pro_f4': 'Inventory + supplier monitoring',
  'pricing_business_f1': 'Unlimited / 50+ users',
  'pricing_business_f2': 'Demand forecasting + disruption detection',
  'pricing_business_f3': 'Auto-replenishment + multi-warehouse',
  'pricing_business_f4': 'ESG reporting',
  'pricing_ent_f1': 'Custom pricing',
  'pricing_ent_f2': 'Enterprise SLA',
  'pricing_ent_f3': 'ERP integrations',
  'pricing_ent_f4': 'Dedicated support',
